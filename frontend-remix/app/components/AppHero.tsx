  ...
  return (
    <div className={cssComponent}>
      <Tag className="inline-block font-font-serif text-xl font-extrabold md:text-4xl">
        {copy && (
          <div className="font-font-monospace text-base font-normal md:text-2xl animate-fade-in-out-zoom">
            {copy}
          </div>
        )}
        ...
        <div className="font-font-monospace text-base font-normal md:text-2xl opacity-0 animate-fade-in-zoom text-center"> Always on the grind.</div>
      </Tag>
    </div>
  );
};
