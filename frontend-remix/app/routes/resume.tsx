...
export const meta: MetaFunction = (args) => {
  return [
    ...
    {
      name: "description",
      content: `The online resume of ${SITE_AUTHOR}, a Software Engineer located in Dubai, UAE.`,
    },
  ];
...
export default function () {
  return (
    <div className="m-10 max-w-5xl py-10 md:py-20 lg:m-auto">
          ...
          <div className="sticky top-32">
            ...
            <div className="mt-8 flex gap-4 print:hidden">
              <a
                ...
                download={true}
                href="/resume/sanvit-katrekar-cv-2024.pdf"
              >
                Download Resume
              </a>
            </div>
          ...
          <section>
            ...
            <div className="flex items-center gap-10">
              <p>
                ...
                passion lies in creating <b>quality code</b>{" "}
                building apps as far as <b>imagination</b> can take it, and
                aiming for <b>perfection</b>.
              </p>
            </div>
          </section>
          <SectionExperience />
